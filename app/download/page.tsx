  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#f4fbf5] px-6 text-center">
      ...
      <p className="text-gray-500 mb-10 max-w-sm">
        Download Nuzzle to find your dog&rsquo;s community. Available on iOS and
        Android.
      </p>
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <a
          href={PLAY_STORE_URL}
          className="inline-block bg-[#3a7d44] text-white font-medium px-6 py-3 rounded-xl hover:bg-[#2d6235] transition-colors"
        >
